...
function applyOnRootTypeField(field, fn) {
    return applyOnTarget(field, fn, () => field._augmentedTarget);
}

function applyOnRootTypeFieldByTypeMode(schema, type, mode, fn) {
    applyOnTarget(schema, fn, () => findRootTypeFieldForAugmentedTarget(schema, type, mode));
}
