...
const {checkAuth, getJwtPayload, parseReturnFields, ResponseResolver} = require('./utils');
...
class AugmentedArgResolver {
    ...
    async _resolve(
        ...
        const result = new ResponseResolver(
            this.resolvers, ctxs, jwtPayload, {
                ...commonResolverOptions,
                results: !useResponseType || !!returnFields[config.FIELD_NAME_RESULTS],
