...
const {
    ...
    augmentFieldArgs, augmentTypeField, augmentInputTypeField, Response,
} = require("../utils");
        ...
        return this.ensureType(
            ...
            (responseTypeName) => {
                const responseType = new GraphQLObjectType({
                    ...
                    description: getNamedType(fieldType).description
                });
